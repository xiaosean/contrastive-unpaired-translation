...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--use_data_augmentation', action='store_true', help='use data augmentation while training to fit selfie2anime')
        ...
        parser.add_argument('--hinge_loss', action='store_false', help='Apply hinge loss which be applyed in SA-GAN/Big-GAN/SPADE')
